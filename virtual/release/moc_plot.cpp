...
QT_MOC_LITERAL(5, 21, 18),
QT_MOC_LITERAL(6, 40, 17),
QT_MOC_LITERAL(7, 58, 7)
    },
    "Plot\0moveSample\0\0x\0y\0changeCataractSlot\0"
    "changeContactSlot\0contact"
};
...
void Plot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->moveSample((*reinterpret_cast< quint16(*)>(_a[1])),(*reinterpret_cast< quint8(*)>(_a[2]))); break;
        case 1: _t->changeCataractSlot((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->changeContactSlot((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Plot::*_t)(quint16 , quint8 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plot::moveSample)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Plot::moveSample(quint16 _t1, quint8 _t2)
{
