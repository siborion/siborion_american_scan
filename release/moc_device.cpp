...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Device_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 66, 11)
    ...
    "Device\0resiveData\0\0QByteArray*\0"
    "openDevice\0bool*\0doMeasure\0doTimer\0"
    "stopMeasure"
};
...
void Device::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->resiveData((*reinterpret_cast< QByteArray*(*)>(_a[1]))); break;
        case 1: _t->openDevice((*reinterpret_cast< bool*(*)>(_a[1]))); break;
        case 2: _t->doTimer(); break;
        case 3: _t->stopMeasure(); break;
        default: ;
        }
        ...
        {
            typedef void (Device::*_t)(QByteArray * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Device::resiveData)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Device::resiveData(QByteArray * _t1)
{
