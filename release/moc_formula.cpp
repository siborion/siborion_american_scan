...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_formula_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 24, 13)
    ...
    "formula\0refreshFormula\0\0changeFotmula"
};
...
void formula::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->refreshFormula((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->changeFotmula((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject formula::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_formula.data,
      qt_meta_data_formula,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_formula.stringdata))
